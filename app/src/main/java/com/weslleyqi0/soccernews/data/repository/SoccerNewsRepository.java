package com.weslleyqi0.soccernews.data.repository;

import com.weslleyqi0.soccernews.App;
...
public class SoccerNewsRepository {
    ...
    private static final String BASE_URL = "https://digitalinnovationone.github.io/soccer-news-api/";
